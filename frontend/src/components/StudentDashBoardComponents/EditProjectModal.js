...
export default function EditProjectModal({children, project, setUser}) {
                ...
                <ModalContent maxWidth="700px" width="100%" ml="20px" mr="20px">
                    ...
                    <ModalBody>
                        ...
                        <FormControl className='description' mb="20px">
                            <FormLabel htmlFor='description' style={{ fontSize: '14px', color: "#404040c9", marginBottom: '0px', marginTop: '15px' }}>Description (Please add skills)</FormLabel>
                            <Textarea
                                id='description'
                                resize='vertical'
                                value={description}
                        ...
                        <FormControl className='addContributors' mb="20px">
                            <p style={{ fontSize: '18px', color: "#404040", marginBottom: '10px', marginTop: '25px', fontWeight: 'bold' }}>Add Contributors(optional)</p>
