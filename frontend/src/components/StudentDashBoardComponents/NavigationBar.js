        ...
        <div className="nav_container">
            ...
            <div className="navSecond">
                ...
                <div className="navProfilePic">
                    <img className='profileLogo' src={props.user.pic} alt={props.user.firstName} onClick={props.navProfileLogoClick} />
                </div>
            </div>
            <div id="navDropdownContent" className='navDropdown' style={{ display: props.navDropdownShow, maxHeight: "301px", height: props.windowSize[1] - 85 }}>
                <div className="profileAndName">
                    <div className="dropprofilePic">
                        <img className='dropprofileLogo' src={props.user.pic} alt={props.user.firstName}/>
                    </div>
                ...
                <ul>
                    <li className="nav-item">
                        <Link className="nav-item-class" to="/studentDashboard/studentProfile">
                    ...
                    <li className="nav-item">
                        <Link className="nav-item-class" to="/studentDashboard/searchJobs">
                            <Search2Icon width="14px" height="14px" mr="8px" ml="6px" />
                            <span>Search Jobs</span>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/studentDashboard/viewResume" className="nav-item-class">
